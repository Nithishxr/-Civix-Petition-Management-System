...
exports.updatePetition = async (req, res) => {
  try {
    ...
    // ✅ ALLOW BOTH CREATOR + OFFICIAL
    if (
      petition.createdBy.toString() !== req.user.id &&
...
exports.updateStatus = async (req, res) => {
  try {
    ...
    const validStatus = ["pending", "active", "closed"];
